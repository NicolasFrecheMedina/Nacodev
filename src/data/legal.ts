...
interface LegalConfig {
  ...
  vatRegime: Record<Locale, string>
  host: string
  hostUrl: string
  contactRetentionPeriod: Record<Locale, string>
...
export const legalConfig: LegalConfig = {
  ...
  siren: '899 608 434',
  siret: '899 608 434 00010',
  nafCode: '6201Z - Programmation informatique',
  ...
  vatRegime: {
    ...
    es: 'IVA no aplicable - artículo 293 B del Código General Tributario francés',
  },
  host: 'Netlify',
  hostUrl: 'https://www.netlify.com/',
  contactRetentionPeriod: {
    fr: 'Durée de conservation des messages : 12 mois',
    en: 'Message retention period: 12 months',
    es: 'Plazo de conservación de los mensajes: 12 meses',
  },
  // Médiateur de la consommation à renseigner lorsqu'il aura été validé.
  ...
  fr: {
    ...
    legalNotice: {
      ...
      labels: {
        ...
        siren: 'SIREN', siret: 'SIRET', nafCode: 'Code NAF / APE', registrationNumber: 'Immatriculation / RNE', vatRegime: 'Régime de TVA',
      },
    ...
    privacy: [
      { title: 'Responsable du traitement', paragraphs: ['Nicolas Freche - NacoDev est responsable du traitement des données transmises via ce site. Toute question peut être adressée à l’adresse indiquée ci-dessous.'] },
      ...
      { title: 'Durée de conservation', paragraphs: [legalConfig.contactRetentionPeriod.fr] },
  ...
  en: {
    ...
    legalNotice: {
      ...
      labels: {
        ...
        siren: 'SIREN', siret: 'SIRET', nafCode: 'NAF / APE code', registrationNumber: 'Registration / RNE', vatRegime: 'VAT scheme',
      },
    ...
    privacy: [
      ...
      { title: 'Retention', paragraphs: [legalConfig.contactRetentionPeriod.en] },
  ...
  es: {
    ...
    legalNotice: {
      ...
      labels: {
        ...
        siren: 'SIREN', siret: 'SIRET', nafCode: 'Código NAF / APE', registrationNumber: 'Registro / RNE', vatRegime: 'Régimen de IVA',
      },
    ...
    privacy: [
      ...
      { title: 'Conservación', paragraphs: [legalConfig.contactRetentionPeriod.es] },
