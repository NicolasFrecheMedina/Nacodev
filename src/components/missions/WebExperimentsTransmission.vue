...
import { webExperienceProjects } from '@/data/missions'
...
<template>
  <article class="web-transmission">
...
.web-transmission::before { position: absolute; z-index: -1; inset: -1rem; border: 1px solid rgb(155 222 248 / 5%); background: linear-gradient(135deg, rgb(155 222 248 / 3%), transparent 46%); content: ''; pointer-events: none; }
.web-transmission__scan { position: absolute; z-index: 2; top: -1rem; right: -1rem; left: -1rem; height: 3rem; opacity: 0; background: linear-gradient(to bottom, transparent, rgb(155 222 248 / 8%), transparent); pointer-events: none; animation: web-scan 1.15s ease-out 80ms both; }
.transmission-zone { opacity: 0; transform: translateY(0.45rem); animation: web-zone-in 520ms ease-out both; }
.web-transmission__signal { display: flex; align-items: center; gap: 0.6rem; color: rgb(155 222 248 / 68%); font-size: 0.48rem; letter-spacing: 0.18em; text-transform: uppercase; animation-delay: 100ms; }
.web-transmission__signal i { width: 0.3rem; height: 0.3rem; border-radius: 50%; background: var(--color-accent); box-shadow: 0 0 0.7rem var(--color-accent); animation: web-signal-pulse 900ms ease-out 180ms both; }
...
.web-transmission__intro span { color: rgb(155 222 248 / 48%); }
...
.web-project { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 0.75rem; min-width: 0; padding: 0.8rem; border: 1px solid rgb(155 222 248 / 13%); opacity: 0; background: linear-gradient(135deg, rgb(155 222 248 / 5%), rgb(255 255 255 / 1.5%)); box-shadow: inset 0 1px 0 rgb(255 255 255 / 3%); transform: translateY(0.4rem); animation: web-project-in 480ms ease-out both; transition: border-color 220ms ease, background 220ms ease, box-shadow 220ms ease, transform 220ms ease; }
.web-project:hover { border-color: rgb(155 222 248 / 29%); background: linear-gradient(135deg, rgb(155 222 248 / 8%), rgb(255 255 255 / 2%)); box-shadow: 0 0 1.2rem rgb(92 185 219 / 7%); transform: translateY(-1px); }
.web-project__number { align-self: start; color: rgb(155 222 248 / 50%); font-family: monospace; font-size: 0.48rem; letter-spacing: 0.1em; }
...
.web-project p i { width: 0.22rem; height: 0.22rem; border-radius: 50%; background: var(--color-accent); box-shadow: 0 0 0.45rem rgb(155 222 248 / 54%); }
.web-project a { padding: 0.35rem 0; color: var(--color-accent); font-size: 0.45rem; letter-spacing: 0.12em; text-decoration: none; text-transform: uppercase; transition: color 200ms ease, text-shadow 200ms ease; }
.web-project a:hover, .web-project a:focus-visible { color: rgb(220 244 252); text-shadow: 0 0 0.7rem rgb(155 222 248 / 48%); }
...
.web-transmission dt, .web-transmission__principle h4 { margin-bottom: 0.38rem; color: rgb(220 235 241 / 38%); font-size: 0.46rem; font-weight: 400; letter-spacing: 0.16em; }
...
.web-transmission__principle p { color: rgb(184 222 235 / 74%); font-size: 0.49rem; letter-spacing: 0.12em; line-height: 1.65; }
:global(.modal__panel:has(.web-transmission)) { scrollbar-width: thin; scrollbar-color: rgb(116 192 220 / 62%) rgb(1 5 9 / 28%); }
...
:global(.modal__panel:has(.web-transmission)::-webkit-scrollbar-thumb) { border: 1px solid rgb(4 12 18 / 58%); border-radius: 999px; background: rgb(116 192 220 / 55%); }
:global(.modal__panel:has(.web-transmission)::-webkit-scrollbar-thumb:hover) { background: rgb(155 222 248 / 72%); box-shadow: 0 0 0.55rem rgb(155 222 248 / 34%); }
...
@keyframes web-signal-pulse { 0%, 100% { opacity: 1; box-shadow: 0 0 0.7rem var(--color-accent); } 45% { opacity: 0.35; box-shadow: 0 0 0.15rem var(--color-accent); } 72% { opacity: 1; box-shadow: 0 0 1rem 0.15rem rgb(155 222 248 / 30%); } }
