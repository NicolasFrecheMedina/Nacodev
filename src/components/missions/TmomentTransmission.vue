...
<template>
  <article class="tmoment-transmission">
...
.tmoment-transmission::before { position: absolute; z-index: -1; inset: -1rem; border: 1px solid rgb(155 222 248 / 5%); background: radial-gradient(circle at 82% 12%, rgb(155 222 248 / 5%), transparent 38%); content: ''; pointer-events: none; }
.tmoment-transmission__scan { position: absolute; z-index: 2; top: -1rem; right: -1rem; left: -1rem; height: 3rem; opacity: 0; background: linear-gradient(to bottom, transparent, rgb(155 222 248 / 8%), transparent); pointer-events: none; animation: tmoment-scan 1.15s ease-out 80ms both; }
.transmission-zone { opacity: 0; transform: translateY(0.4rem); animation: tmoment-zone-in 520ms ease-out both; }
.tmoment-transmission__signal { display: flex; align-items: center; gap: 0.6rem; color: rgb(155 222 248 / 68%); font-size: 0.48rem; letter-spacing: 0.18em; text-transform: uppercase; animation-delay: 100ms; }
.tmoment-transmission__signal i { width: 0.3rem; height: 0.3rem; border-radius: 50%; background: var(--color-accent); box-shadow: 0 0 0.7rem var(--color-accent); animation: tmoment-signal-pulse 900ms ease-out 180ms both; }
...
.tmoment-transmission__intro span { color: rgb(155 222 248 / 48%); }
...
.tmoment-transmission__timeline a, .tmoment-transmission__disabled { padding: 0.35rem 0; border: 0; color: var(--color-accent); background: transparent; font: inherit; font-size: 0.5rem; letter-spacing: 0.14em; text-decoration: none; text-transform: uppercase; cursor: pointer; transition: color 200ms ease, text-shadow 200ms ease; }
.tmoment-transmission__timeline a:hover, .tmoment-transmission__timeline a:focus-visible { color: rgb(220 244 252); text-shadow: 0 0 0.7rem rgb(155 222 248 / 48%); }
.tmoment-transmission__disabled { opacity: 0.38; cursor: not-allowed; }
.tmoment-transmission__timeline > i { position: relative; height: 1px; background: rgb(155 222 248 / 14%); }
.tmoment-transmission__timeline > i::before { position: absolute; inset: 0; background: linear-gradient(90deg, transparent, var(--color-accent)); box-shadow: 0 0 0.5rem rgb(155 222 248 / 30%); content: ''; transform: scaleX(0); transform-origin: left; animation: tmoment-timeline-rewind 760ms cubic-bezier(0.22, 1, 0.36, 1) 460ms forwards; }
.tmoment-transmission__timeline em { position: absolute; top: 50%; left: 50%; display: grid; width: 1.35rem; height: 1.35rem; border: 1px solid rgb(155 222 248 / 44%); border-radius: 50%; opacity: 0; color: var(--color-accent); background: rgb(6 14 20); font-style: normal; place-items: center; transform: translate(-50%, -50%); animation: tmoment-marker-in 500ms ease-out 720ms forwards; }
...
.tmoment-transmission__target b { color: var(--color-accent); font-weight: 500; }
...
.tmoment-transmission dt, .tmoment-transmission__readouts h4 { margin-bottom: 0.38rem; color: rgb(220 235 241 / 38%); font-size: 0.46rem; font-weight: 400; letter-spacing: 0.16em; }
...
.tmoment-transmission__readouts p { color: rgb(184 222 235 / 74%); font-size: 0.49rem; letter-spacing: 0.12em; line-height: 1.65; }
:global(.modal__panel:has(.tmoment-transmission)) { scrollbar-width: thin; scrollbar-color: rgb(116 192 220 / 62%) rgb(1 5 9 / 28%); }
...
:global(.modal__panel:has(.tmoment-transmission)::-webkit-scrollbar-thumb) { border: 1px solid rgb(4 12 18 / 58%); border-radius: 999px; background: rgb(116 192 220 / 55%); }
:global(.modal__panel:has(.tmoment-transmission)::-webkit-scrollbar-thumb:hover) { background: rgb(155 222 248 / 72%); box-shadow: 0 0 0.55rem rgb(155 222 248 / 34%); }
...
@keyframes tmoment-signal-pulse { 0%, 100% { opacity: 1; box-shadow: 0 0 0.7rem var(--color-accent); } 45% { opacity: 0.35; box-shadow: 0 0 0.15rem var(--color-accent); } 72% { opacity: 1; box-shadow: 0 0 1rem 0.15rem rgb(155 222 248 / 30%); } }
