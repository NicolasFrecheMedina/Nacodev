...
.trajectory-node:is(:hover, :focus-visible) { transform: translate(-50%, -50%) scale(calc(var(--node-scale) * 1.38)); }
...
.trajectory-node:is(:hover, :focus-visible) .trajectory-node__orbit, .trajectory-node--selected .trajectory-node__orbit { border-color: rgb(255 242 200 / 82%); box-shadow: 0 0 2.8rem rgb(255 232 168 / 38%), 0 0 1.15rem rgb(255 246 218 / 42%), inset 0 0 1.2rem rgb(255 244 207 / 18%); transform: rotate(35deg) scale(1.34); }
.trajectory-node:is(:hover, :focus-visible) .trajectory-node__core, .trajectory-node--selected .trajectory-node__core { width: 0.58rem; height: 0.58rem; background: #fff4d5; box-shadow: 0 0 0.75rem rgb(255 244 211 / 92%), 0 0 2.4rem rgb(255 226 151 / 58%); animation: trajectory-node-pulse 1.5s ease-in-out infinite; }
...
.trajectory-node:is(:hover, :focus-visible) .trajectory-node__core::before, .trajectory-node--selected .trajectory-node__core::before { opacity: 1; animation: trajectory-halo-pulse 1.5s ease-in-out infinite; }
...
@media (max-width: 700px) {
  ...
  .trajectory-node:is(:hover, :focus-visible), .trajectory-node--selected { transform: scale(1.18); }
