...
.missions-scene__header, .missions-scene__telemetry, .missions-scene__continue { transition: opacity 360ms ease; }
.missions-scene--emerging .missions-scene__header, .missions-scene--emerging .missions-scene__telemetry, .missions-scene--emerging .missions-scene__continue { opacity: 0; }
.missions-scene--stabilizing .missions-scene__header, .missions-scene--stabilizing .missions-scene__telemetry, .missions-scene--stabilizing .missions-scene__continue { transition-duration: 200ms; }
...
@media (prefers-reduced-motion: reduce) { .missions-scene { transition-duration: 120ms; } .missions-scene--stabilizing .missions-scene__header, .missions-scene--stabilizing .missions-scene__telemetry, .missions-scene--stabilizing .missions-scene__continue, .mission-panel-enter-active, .mission-panel-leave-active { transition-duration: 120ms; } .missions-scene--departing :deep(.mission-system) { transition-duration: 170ms; transform: none; } .missions-scene__departure-orbits { display: none; } }
</style>
